...
Public Class FormFamilyHK
    Delegate Sub ProgressReportDelegate(ByVal id As Integer, ByVal message As String)
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myAdapter As FamilyAdapter
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        Try
            If User.can("createFamilyHK") Then
    ...
    Private Sub ShowTx(ByVal StatusTx As TxRecord)
        ...
        End Select
        Dim myform As New DialogFamilyHK(drv)
        myform.ShowDialog()
    End Sub
    ...
    Public Sub New()
        ...
        RemoveHandler DialogFamilyHK.FinishUpdate, AddressOf RefreshDataGrid
        AddHandler DialogFamilyHK.FinishUpdate, AddressOf RefreshDataGrid
    End Sub
