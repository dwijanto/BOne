...
Public Class FormHKWarehouse
    Dim selectedDate As Date
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Private myAdapter As New HKWarehouseAdapter
    ...
    Private Sub DoWork()
        ...
        myAdapter = New HKWarehouseAdapter
    ...
    Private Sub DoExcelWork()
        ...
        Dim myreport As New ExcelExtract(Me, mysaveform.FileName, datasheet, "\templates\warehouse.xltx", mycallback, PivotCallback)
        ProgressReport(1, "Generate Report.")
